...
public class RequestHeaderBasedSingedSessionFilter extends AbstractSignedSessionFilter {
	...
	protected SignedSessionAuthenticationToken signedSession(HttpServletRequest request, HttpServletResponse response) {
		String sessionId = request.getHeader(this.signedSessionService.getSessionParameterName());
	...
	protected void initFilterBean() throws ServletException {
		...
		Assert.notNull(signedSessionService, "SignedSessionService must be set on RequestHeaderBasedSingedSessionFilter.");
	}
}
